 ...
 * Extracted from Groogather team implementation for better maintainability
 */
...
namespace Pathfinding {
  ...
  My intuition tells me the other options are redundant other than facing (facing could set us up for optimal paths), but here Im trying to think of a quick fix that could dramatically improve groogather without going all the way to optimal paths.
  */
