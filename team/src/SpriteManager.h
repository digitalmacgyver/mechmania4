...
// Sprite types based on graphics.reg - indices match order in parsed file (comments excluded)
enum SpriteType {
    // Impact/damage sprites (0-17 + bonk at 12)
    SPRITE_SHIP_IMPACT = 0,         // shpimp000-017 (first 18 sprites, bonk.xpm at index 12)
